...
bool Allocator::set_chunk_executable(uint8_t *Pointer, uint64_t Size) noexcept {
  ...
  return boost::winapi::VirtualProtect(
             Pointer, Size, boost::winapi::PAGE_EXECUTE_READ_, nullptr) != 0;
#else
  return true;
#endif
}
...
#elif WASMEDGE_OS_WINDOWS
  return boost::winapi::VirtualProtect(
             Pointer, Size, boost::winapi::PAGE_READONLY_, nullptr) != 0;
#else
  return true;
#endif
}
...
#elif WASMEDGE_OS_WINDOWS
  return boost::winapi::VirtualProtect(
             Pointer, Size, boost::winapi::PAGE_READWRITE_, nullptr) != 0;
#else
  return true;
#endif
}
